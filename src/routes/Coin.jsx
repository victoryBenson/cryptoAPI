      ...
      <div className='coin-container'>
        ...
        <div className='content'>
          ...
          <div className='info'>
            <div className='coin-heading'>
              {coin.image? <img src={coin.image.small} alt="icon" /> : null}
              <p>{coin.name}</p>
        ...
        <div className='content'>
          <div className='stats'>
            <div className='left'>
              <div className='row'>
                <h4 className='font-bold text-lg'>24 Hour Low</h4>
                {coin.market_data?.low_24h ? <p>${coin.market_data.low_24h.usd.toLocaleString()}</p> : null}
              </div>
              <div className='row'>
                <h4 className='font-bold text-lg'>24 Hour High</h4>
                {coin.market_data?.high_24h ? <p>${coin.market_data.high_24h.usd.toLocaleString()}</p> : null}
              </div>
            </div>
            <div className='right'>
              <div className='row'>
                <h4 className='font-bold text-lg'>Market Cap</h4>
                {coin.market_data?.market_cap ? <p>${coin.market_data.market_cap.usd.toLocaleString()}</p> : null}
              </div>
              <div className='row'>
                <h4 className='font-bold text-lg'>Circulating Supply</h4>
